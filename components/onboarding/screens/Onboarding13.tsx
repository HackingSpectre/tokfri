...
export default function Onboarding13({ onNext, onSkip }: Onboarding13Props) {
  return (
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 py-12">
        ...
        <div className="text-center max-w-lg animate-slide-up" style={{ animationDelay: '0.1s' }}>
          ...
          <p className="text-gray-600 text-base md:text-lg leading-relaxed">
            Join communities, create groups, and connect with people who share your passions and interests.
          </p>
        </div>
