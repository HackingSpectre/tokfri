...
export default function Onboarding12({ onNext, onSkip }: Onboarding12Props) {
  return (
    <div className="min-h-screen w-full bg-white flex flex-col">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 py-12">
        ...
        <div className="relative w-full max-w-md h-64 md:h-80 mb-8 animate-slide-up">
          <Image
            src="/images/onboarding/Frame 2-3.png"
            alt="Engage and Interact"
            fill
        ...
        <div className="text-center max-w-lg animate-slide-up" style={{ animationDelay: '0.1s' }}>
          ...
          <p className="text-gray-600 text-base md:text-lg leading-relaxed">
            Like, comment, and share. Build meaningful connections and engage with content that matters to you.
          </p>
        </div>
